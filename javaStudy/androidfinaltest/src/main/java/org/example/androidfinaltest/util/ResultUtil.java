...
import org.example.androidfinaltest.entity.Result;
...
public class ResultUtil {
    ...
    public static String usernameExist(String message) {
        return usernameExist(409, message);
    }
    public static String usernameExist(Integer code, String message) {
        Result result = new Result();
        result.setCode(code);
        result.setMessage(message);
